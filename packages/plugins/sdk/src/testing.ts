    ...
    issues: {
      ...
      async createInteraction(issueId, interaction, companyId, options) {
        ...
        const created: IssueThreadInteraction = {
          ...
          resolverPolicy: interaction.resolverPolicy ?? "board_only",
          requestedResolverPolicy: interaction.resolverPolicy ?? "board_only",
          effectiveResolverPolicy: interaction.resolverPolicy ?? "board_only",
